...
const Navbar = () => {
  return (
    <header className="flex items-center px-20 py-5 md:space-x-8 shadow-3xl max-w-full z-20 sticky inset-x-0 top-0 bg-white">
      ...
      <nav className="w-full">
        <ul className="list-none flex flex-col md:flex-row justify-around ">
          <li>
            <NavLink
              to="#"
              className="text-sm text-gray-500 font-medium hover:text-violet-400"
            >
              Men
            </NavLink>
          </li>
      ...
      <div className="relative hidden md:block w-88">
        ...
        <input
          type="text"
          id="search-navbar"
          className="block w-88 p-2 pl-10 text-sm text-gray-900 border-2 border-neutral-100 rounded-md bg-neutral-100 outline-none focus:bg-white focus:ring-violet-400 focus:border-violet-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-400"
